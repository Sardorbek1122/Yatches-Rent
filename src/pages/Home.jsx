...
import FindCarForm from "../components/UI/FindYachtForm";
        ...
        <div className="hero__form">
          <Container>
            <Row className="form__row">
              <Col lg="4" md="4">
                <div className="find__yacht-left">
                  <h3>Yacht Escapes Redefined: Find Yours Today</h3>
                </div>
              </Col>
